...
const OrderBuyModal1 = ({ closeModal, visible }) => {
    ...
    <Modal animationType="none" visible={visible}>
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.header}>
          <Text style={styles.headerText}>Order Buy Detail</Text>
        </View>
        ...
        >
          <View style={{ width: windowWidth }}>
            <OrderBuyCurrent index={index} setIndex={setIndex} />
          </View>
          <View style={{ width: windowWidth }}>
            <OrderBuyComplete index={index} setIndex={setIndex} />
          </View>
        </ScrollView>
      </View>
    </Modal>
